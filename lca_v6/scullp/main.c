...
static ssize_t scullp_aio_read(struct kiocb *iocb, const struct iovec *iovec,unsigned long nr_segs ,
		loff_t pos)
{
	return scullp_defer_op(0, iocb, iovec, nr_segs, pos);
}

static ssize_t scullp_aio_write(struct kiocb *iocb, const struct iovec *iovec,unsigned long nr_segs ,
		loff_t pos)
{
